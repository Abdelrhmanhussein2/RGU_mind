...
export function StudentResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await resetPassword(email, otp, formData.password, "student");
      setIsSuccess(true);
  ...
  return (
    <AuthLayout
      ...
      subtitle="Choose a strong password to protect your account and keep your academic information secure."
    >
