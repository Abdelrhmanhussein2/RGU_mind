...
export function AdminOtpVerification() {
  ...
  return (
    <AuthLayout
      ...
      subtitle="We've sent a 6-digit verification code to your registered admin email. Please enter it below."
    >
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-4">6-Digit OTP Code</label>
